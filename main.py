from ui import MainWindow, SceneFileItemWidget, UsdFileItemWidget
from lib import ProjectDataBase, UsdManager, FileManager
...
class MercuryWindow:
    def __init__(self):
        ...
        self.main_window = MainWindow()  # Store as instance variable
        self.app.setStyleSheet(self.main_window.app_style_sheet())
...
if __name__ == "__main__":
    ...
    mercury_window.show()
    sys.exit(mercury_window.app.exec_())